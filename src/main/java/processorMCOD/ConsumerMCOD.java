...
import com.amazonaws.netdataresttest.utils.ConfigurationUtils;
import com.amazonaws.netdataresttest.utils.CredentialUtils;

/**
 * Uses the Kinesis Client Library (KCL) to continuously consume and process records 
 * from the IoT Platform. KCL monitors the number of shards and creates
 ...
 *
 */
public class ConsumerMCOD {

    private static final Log LOG = LogFactory.getLog(ConsumerMCOD.class);
    ...
    private static void checkUsage(String[] args) {
        if (args.length != 3) {
            System.err.println("Usage: " + ConsumerMCOD.class.getSimpleName()
    ...
    public static void main(String[] args) throws Exception {
        ...
        IRecordProcessorFactory recordProcessorFactoryMcod = new CpuUsageRecordProcessorFactoryMCOD();

        // Create the KCL worker with the stock trade record processor factory
        Worker worker = new Worker(recordProcessorFactoryMcod, kclConfig);
